...
def authFunc(packet):
    ...
    if IP in pkt:
       ...
       if (mac_src != None or ip_src != "192.168.1.1" or ip_src != "192.168.1.3"):
          ...
          if(contract.functions.authFunc(deviceID).call()):
            ...
            os.system(f"sudo aireplay-ng -0 30 -a dc:a6:32:74:73:35 -c {mac_src} wlan1")
            packet.drop()
    else: 
        packet.accept()
...
def main():
    ...
    os.system("sudo airmon-ng start wlan1 6") #6 indicates the channel
